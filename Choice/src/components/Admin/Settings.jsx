...
const Profile = () => {
          ...
          return (
                    <Layout>
                              ...
                              <div className="bg-white mx-auto md:my-8 shadow-lg rounded p-6 md:w-8/12 border">
                              ...
                              <div className="mx-auto md:my-8 shadow-lg rounded p-6 md:w-8/12 border bg-white">
                                        <div className="flex items-center gap-1">
